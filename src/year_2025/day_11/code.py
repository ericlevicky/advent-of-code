"""Advent of Code 2025 Day 11 scaffolding."""
...
def part1(file_name: str = "input.txt") -> int:
    ...
    raise NotImplementedError("Day 11 part 1 has not been implemented yet.")


def part2(file_name: str = "input.txt") -> int:
    """Solve part 2 of the puzzle."""
    data = parse_input(load_input(file_name))
    raise NotImplementedError("Day 11 part 2 has not been implemented yet.")
